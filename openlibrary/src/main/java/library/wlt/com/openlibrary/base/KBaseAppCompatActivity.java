...
import library.wlt.com.openlibrary.R;
import library.wlt.com.openlibrary.utils.AppManager;


/**
 * Created by PC_WLT on 2017/4/6.
 * 1.集成ButterKnife
 * 2.仿照Ios，点击编辑框以外，自动隐藏软键盘（自动）
 * 3.基本跳转简化 （open(Activity)）
 *
 * butterKnife 工具类不能放在Library中，否则无法使用 （需要在项目app中集成环境）
 */

public abstract class KBaseAppCompatActivity extends AppCompatActivity {
...
//        ButterKnife.bind(this);
    ...
    protected abstract void initButterKnife(Context context);
...
//        Bugtags.onDispatchTouchEvent(this, ev);
    ...
    protected void openActivity(Class<?> pClass, Bundle pBundle, Uri uri) {
        ...
        overridePendingTransition(R.anim.activity_left_enter, R.anim.activity_left_enter_hide);
    }
     ...
     * @param requestCode
     */
    protected void openActivityForResult(Class<?> pClass, Bundle b, int requestCode){
        Intent intent = new Intent(this,pClass);
        if (b != null) {
            intent.putExtras(b);
        }
